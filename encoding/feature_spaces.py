...
def get_eng1000_ind_only(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_induction_zero(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_induction_zero_b(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_both_induction_zero(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_both_induction_zero_b(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_vectors_w_induction(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_vectors_w_weighted_induction(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_random_induction(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_fuzzy_induction_sd(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_fuzzy_induction_s(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_fuzzy_induction_d(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng1000_w_fuzzy_induction_a(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_eng_window_vectors(allstories, x, k):
...
def get_eng_window_avg(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_k_window_avg(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_k_window(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_window_vectors_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_window_avg_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_k_window_avg_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_eng_k_window_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_ind_only(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_2x(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_window_avg(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama(allstories, x, k, model=None, tokenizer=None):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_k_window_avg(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_k_window(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
""""
def get_llama_window_eng(allstories, x, k):
...
def get_llama_window_avg_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_k_window_avg_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_k_window_b(allstories, x, k):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_w_prefix_same(allstories, x, k, model, tokenizer):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_w_prefix_and_suffix(allstories, x, k, model, tokenizer):
	"""Get llama vectors (300-d) for specified stories.
...
def get_llama_w_prefix_att(allstories, x, k, model, tokenizer):
	"""Get llama vectors (300-d) for specified stories.
...
def get_incont_fuzzy_infinigram_gpt(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_fuzzy_infinigram_llama(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_dist_infinigram_gpt(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_dist_infinigram_llama(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_infinigram(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_infinigram_w_cont(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_infinigram(allstories, x, k, batch_size=100):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_infinigram_p(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_infinigram_w_cont_p(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_infinigram_p(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_infinigram_gpt_p(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_incont_infinigram_llama_p(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_pca_tr_infini_general(allstories, x, k, vec_location_suffix):
	"""Get Eng1000 vectors (985-d) for specified stories.
...
def get_pca_tr_infini(allstories, x, k):
    ...
    return get_pca_tr_infini_general(allstories, x, k, "infinigram")


def get_pca_tr_infini_w_cont(allstories, x, k):
    """Calls the general PCA TR function with infinigram_w_cont vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "infinigram_w_cont")


def get_pca_tr_incont_infini(allstories, x, k):
    """Calls the general PCA TR function with incont_infinigram vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "incont_infinigram")

def get_pca_tr_incont_fuzzy_gpt(allstories, x, k):
    """Calls the general PCA TR function with incont_infinigram vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "incont_fuzzy_gpt")

def get_pca_tr_incont_fuzzy_llama(allstories, x, k):
    """Calls the general PCA TR function with incont_infinigram vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "incont_fuzzy_llama")

def get_pca_tr_incont_dist_gpt(allstories, x, k):
    """Calls the general PCA TR function with incont_infinigram vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "incont_dist_gpt")

def get_pca_tr_incont_dist_llama(allstories, x, k):
    """Calls the general PCA TR function with incont_infinigram vectors."""
    return get_pca_tr_infini_general(allstories, x, k, "incont_dist_llama")
...
def get_pca_infini(allstories, x, k):
	"""Get Eng1000 vectors (985-d) for specified stories.
