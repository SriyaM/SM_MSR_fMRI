...
cdef class CTMfile:
    ...
    def getMesh(self):
        ...
        cdef unsigned int i
        cdef unsigned int npts = openctm.ctmGetInteger(self.ctx, openctm.CTM_VERTEX_COUNT)
        cdef unsigned int npolys = openctm.ctmGetInteger(self.ctx, openctm.CTM_TRIANGLE_COUNT)
        ...
        cdef float* cpts = openctm.ctmGetFloatArray(self.ctx, openctm.CTM_VERTICES)
        cdef unsigned int* cpolys = openctm.ctmGetIntegerArray(self.ctx, openctm.CTM_INDICES)
